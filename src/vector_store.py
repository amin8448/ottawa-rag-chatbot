...
class VectorStore:
        ...
        try:
            ...
            try:
                self.current_collection = self.client.create_collection(
                    name=name,
                    metadata=metadata
                    or {"description": "Ottawa city services documents"},
    ...
    def add_documents(
        ...
        try:
            if not self.current_collection:
                self.logger.error(
                    "No collection selected. Call create_collection() first."
                )
                return False
    ...
    def search_by_text(
        ...
        try:
            ...
            self.logger.warning(
                "Text search requires embedding function. Use search() with pre-computed embeddings."
            )
            return []
    ...
    def restore_collection(
        self, backup_path: str, collection_name: Optional[str] = None
    ) -> bool:
    ...
    def get_database_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "current_collection": (
                    self.collection_name if self.current_collection else None
                ),
            }
...
if __name__ == "__main__":
    ...
    vector_store = VectorStore(
        db_path="data/embeddings/chroma_db", collection_name="ottawa_test"
    )
