...
class DataProcessor:
    ...
    def validate_chunks(self, chunks: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            validation_report = {
                ...
                "chunks_below_min": sum(1 for length in chunk_lengths if length < self.min_chunk_length),
                "chunks_above_max": sum(1 for length in chunk_lengths if length > self.chunk_size * 1.5),
            ...
            if validation_report["chunks_below_min"] > 0:
                issues.append(f"{validation_report['chunks_below_min']} chunks below minimum length")
    ...
    def process_full_dataset(self, save_results: bool = True) -> Tuple[List[Dict], List[Dict]]:
        """
